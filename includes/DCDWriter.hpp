#ifndef ARABICA_DCD_WRITER
#define ARABICA_DCD_WRITER
#include "DCDDef.hpp"
//TODO maneger: set paras from reader
...
//             std::cout << "fileinfo size: " << fileinfo.size() << std::endl;
        ...
        char line3[81] = "==================== This file is modified using arabica-tools =================";
        char line4[81];
